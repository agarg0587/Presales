...
void flow()
{
    ...
    ns_web_url ("searchProduct",
        "URL=https://184.105.48.12/nsecom/searchProduct?keyword={search_item}",
        "HEADER=Upgrade-Insecure-Requests:1",
    ...
    ns_web_url ("productPage",
        "URL=https://184.105.48.12/nsecom/productPage?productid={product_id}&upc=ShirtUPC11111&prodImage=shirt1.png&prodPrice={product_price}",
        "HEADER=Upgrade-Insecure-Requests:1",
        "HEADER=Sec-Fetch-Site:same-origin",
        "HEADER=Sec-Fetch-Mode:navigate",
        "HEADER=Sec-Fetch-User:?1",
    ...
    ns_web_url ("shippingAddress",
        "URL=https://184.105.48.12/nsecom/shippingAddress?productid=NA&upc=ShirtUPC11111&size=2&color=blue&quantity=1&price=19.99&status=true&cartId={cart_id}",
        "HEADER=Upgrade-Insecure-Requests:1",
        "HEADER=Sec-Fetch-Site:same-origin",
        "HEADER=Sec-Fetch-Mode:navigate",
        "HEADER=Sec-Fetch-User:?1",
    ...
    ns_web_url ("checkOut",
        "URL=https://184.105.48.12/nsecom/checkOut?name={p_name}&address=hyderabad&city={p_city}&PostalCode={postal_code}&country=India&productid=NA&upc=ShirtUPC11111&size=2&color=blue&quantity=1&price=19.99&status=true&cartId={cart_id}",
        "HEADER=Upgrade-Insecure-Requests:1",
        "HEADER=Sec-Fetch-Site:same-origin",
        "HEADER=Sec-Fetch-Mode:navigate",
        "HEADER=Sec-Fetch-User:?1",
